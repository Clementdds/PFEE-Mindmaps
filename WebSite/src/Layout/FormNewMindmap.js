...
const FormNewMindmap = ({error, result, dispatch}) => {
                ...
                <div>
                    ...
                    <div>
                        <div className="row">
                            <div className="col-3 text-right">
                                <svg width="2em" height="2em" viewBox="0 0 16 16"
                                     className="bi bi-file-earmark-fill text-icon" fill="currentColor"
                        ...
                        <div className="row marginTop2p">
                            <div className="col-3 text-right">
                                <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-upload text-icon"
                        ...
                        <div className="row marginTop2p">
                            <div className="col-3 text-right">
                                {isPublic ?
                                    <svg width="2em" height="2em" viewBox="0 0 16 16"
                                         className="bi bi-eye-fill greenEyes" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            <div className="row">
                                <div className="col-3 text-right">
                                    <svg width="2em" height="2em" viewBox="0 0 16 16"
                                         className="bi bi-share-fill text-icon" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd"
